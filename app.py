...
def home():
    ...
    try:
        ...
        return redirect(url_for("login", msg="Login session is expired"))
    except jwt.exceptions.DecodeError:
        return redirect(url_for("login", msg="Login data does not exist"))
...
def sign_in():
    ...
    # 찾지 못하면
        ...
        return jsonify({'result': 'fail', 'msg': 'ID/Passcode are not correct, who are you?'})
...
def posting():
    ...
    try:
        ...
        return jsonify({"result": "success", 'msg': 'Success Sharing'})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
...
def get_posts():
    ...
    try:
        ...
        return jsonify({"result": "success", "msg": "Postings have been updated", "posts": posts})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
